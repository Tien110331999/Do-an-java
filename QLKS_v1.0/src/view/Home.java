...
public final class Home extends javax.swing.JFrame {
                ...
                try (ResultSet rs2 = conn.ExcuteQueryGetTable("Select* from DAT_PHONG where SOPHONG='"+SOPHONG+"'")) {
                    while(rs2.next()){
                        ...
                        try (ResultSet rs3 = conn.ExcuteQueryGetTable("Select* from DAT_PHONG where SOPHONG='"+SOPHONG+"' "
                                + "and NGAYTHUE<=GETDATE() and NGAYTRA>=GETDATE() ")) {
                            while(rs3.next()){
    ...
    public void SetTinhTrangPhongDateToDate(String DateIn, String DateOut)  {
        Date date1 = new SimpleDateFormat("yyyy-MM-dd").parse(DateIn);
        Date date2 = new SimpleDateFormat("yyyy-MM-dd").parse(DateOut);
        
        if(date1.compareTo(date2)>=0){
            JOptionPane.showMessageDialog(rootPane,"Ngày trả phải lớn hơn ngày nhận!!");
        }else {
                    int i=0;
        Arrays.fill(Tinhtrangphong, "");
        Arrays.fill(Madatphong, "");
            ...
            while(rs1.next()){
                ...
                try (ResultSet rs2 = conn.ExcuteQueryGetTable("Select* from DAT_PHONG where SOPHONG='"+SOPHONG+"'")) {
                    while(rs2.next()){
                        check_1 = true;
                        boolean check_2= false;
                        try (ResultSet rs3 = conn.ExcuteQueryGetTable("Select MADAT from DAT_PHONG where SOPHONG='"+SOPHONG+"' "
                                + "and NGAYTHUE < " + "'" +DateOut+ "'" 
                                        + " or NGAYTRA > "+"'" +DateIn+"' ;" )) {
                            while(rs3.next()){
                                String MADAT= rs3.getString("MADAT");
                                check_2=true;
            ...
            while(rs1.next()){
                ...
                try (ResultSet rs2 = conn.ExcuteQueryGetTable("Select* from DAT_TIEC where MASANH='"+MASANH+"'")) {
                    while(rs2.next()){
                        ...
                        check_1 = true;
                        boolean check_2= false;
                        try (ResultSet rs3 = conn.ExcuteQueryGetTable("Select SOTIEC from DAT_TIEC where MASANH='"+MASANH+"' "
                                + "and TGDIENRA = GETDATE();")) {
                            while(rs3.next()){
                                ...
                                check_2=true;
                                boolean check_3= false;
                                try (ResultSet rs4 = conn.ExcuteQueryGetTable("Select TINHTRANG from HD_TIEC where SOTIEC='"+SOTIEC+"'")) {
                                    while(rs4.next()){
                                        check_3=true;
                                        if (rs4.getString("TINHTRANG").equals("chua thanh toan")){
    ...
    public void SetTinhTrangSanhDate(String DateIn2){
        ...
        Arrays.fill(Tinhtrangsanh, "");
        Arrays.fill(Madattiec, "");
        ResultSet rs1 = conn.ExcuteQueryGetTable("Select MASANH from SANH where TINHTRANG not in(select TINHTRANG from SANH where TINHTRANG='sua')");
        try {
            while(rs1.next()){
                String MASANH = rs1.getString("MASANH");
                for(int index=0;index<6;index++){
    ...
    private void initComponents() {
        ...
        setTitle("QUẢN LÝ NHÀ HÀNG & KHÁCH SẠN");
        setResizable(false);
        ...
        jLabel24.setText("v1.0.2");

        jLabel25.setText("© 2019, Banana Brothers");
        ...
        jLabel31.setText("One");

        jLabel32.setText("Trần Trọng Tiến - 17521133");
        ...
        Lap_phieuLayout.setVerticalGroup(
            Lap_phieuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(Lap_phieuLayout.createSequentialGroup()
                .addComponent(jTabbedPane4, javax.swing.GroupLayout.PREFERRED_SIZE, 444, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel50Layout.setVerticalGroup(
            ...
            .addGroup(jPanel50Layout.createSequentialGroup()
                ...
                .addGroup(jPanel50Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(ComboBoxloaiphong, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(jScrollPane20, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel51Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel51Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane22, javax.swing.GroupLayout.DEFAULT_SIZE, 352, Short.MAX_VALUE))
        );
        ...
        Tang_tretLayout.setVerticalGroup(
            ...
            .addGroup(Tang_tretLayout.createSequentialGroup()
                ...
                .addGroup(Tang_tretLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(Jphong2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
                    .addComponent(Jphong5, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(Jphong3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane16, javax.swing.GroupLayout.DEFAULT_SIZE, 634, Short.MAX_VALUE))
        );
        jPanel14Layout.setVerticalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addComponent(jPanel41, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
            .addComponent(jScrollPane16, javax.swing.GroupLayout.DEFAULT_SIZE, 413, Short.MAX_VALUE)
        );
        ...
        QL_khachLayout.setVerticalGroup(
            QL_khachLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(QL_khachLayout.createSequentialGroup()
        ...
        jPanel30Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel30Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane15, javax.swing.GroupLayout.DEFAULT_SIZE, 655, Short.MAX_VALUE)
                .addContainerGap())
        );
            ...
            .addGroup(jPanel53Layout.createSequentialGroup()
                .addGroup(jPanel53Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel53Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Tongtien_1, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jPanel58Layout.setVerticalGroup(
            ...
            .addGroup(jPanel58Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel60, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addComponent(jScrollPane23, javax.swing.GroupLayout.DEFAULT_SIZE, 402, Short.MAX_VALUE)
        );
        ...
        jPanel45Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel45Layout.createSequentialGroup()
                ...
                .addGroup(jPanel45Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel45Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel59, javax.swing.GroupLayout.PREFERRED_SIZE, 119, Short.MAX_VALUE)
                        .addContainerGap())
                    .addGroup(jPanel45Layout.createSequentialGroup()
                        .addGap(39, 39, 39)
        ...
        jPanel45Layout.setVerticalGroup(
            ...
            .addGroup(jPanel45Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel45Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel60, javax.swing.GroupLayout.DEFAULT_SIZE, 42, Short.MAX_VALUE)
                    .addGroup(jPanel45Layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPanel33, javax.swing.GroupLayout.PREFERRED_SIZE, 517, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void LapPhieuThueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LapPhieuThueActionPerformed
        ...
        String SOHDDV="";
        try {
            ResultSet rs3 = conn.ExcuteQueryGetTable("SELECT NEXT VALUE FOR SOHDDV_SEQ;");
                        while(rs3.next()){
                            SOHDDV=rs3.getString("'HD'|| NEXT VALUE FOR SOHDDV_SEQ");
                        }
            ...
            if (index!=-1){
                ...
                if (check==true){
                    ...
                    while(rs1.next()){                 
                        ...
                        conn.ExcuteQueryUpdateDB("Insert into HD_DICH_VU VALUES('"+SOHDDV+"','"+MANV+"','"+MADAT+"',0,GETDATE());");
                        ...
                        conn.ExcuteQueryUpdateDB("Insert into LUU_TRU values('LT'||NEXT VALUE FOR ID_SEQ),'"+rs1.getString("SOPHONG")
        ...
        if (!text.equals("")){
            try {
                ...
                if(Hoten1.isSelected()){
                    try (ResultSet rs1 = conn.ExcuteQueryGetTable("SELECT * FROM LUU_TRU where HOTEN='"+text+"' and (NGAYDEN<=SYSDATE and SYSDATE<=NGAYDI)")) {
                        while(rs1.next()){
                            check=true;
